...
export const STORY_PARAGRAPHS = [
  ...
  {
    key: 'free-tier',
    text: "The free tier took a while to decide on because the infrastructure and maintenance costs are real. The obvious move would have been to gate most things, but I wanted Divine Monitor to be genuinely useful without forcing an upgrade. So Free gives you access to the full data experience: the extension, your Vine history, analytics, and the full Global Console from anywhere. Plus is there for the people who want that data turned into actionable notifications across channels like Telegram, email, and browser push. Those notifications have real running costs too, from orchestration and delivery infrastructure to third-party provider costs like email. The core Vine page enhancements are free as well, from reclaiming space on the page to multi-photo upload during reviews. Things like hiding the opt-out button are personal. I know the anxiety of seeing it sitting there, waiting to be accidentally clicked, and I wanted to remove that for anyone who gets the same feeling.",
  },
]
